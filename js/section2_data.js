const questions = [
            ...
            {
                q: "What triggers an anonymous lead to become a known lead in Marketo?",
                options: [
                    "Visiting any landing page",
                    "Clicking a link in an email",
                    "Form submission with email address",
                    "Being added to a Static List"
                ],
                correct: [2],
                explanation: "An anonymous lead becomes known when they submit a form with an email address. This is the primary conversion method. Simply visiting pages keeps them anonymous (tracked by cookie only). Clicking email links already requires them to be known. Being added to a list requires the person to already exist in the database."
            },
            {
