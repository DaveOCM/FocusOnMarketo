const questions = [
            ...
            {
                q: "Which of the following is an appropriate use of an Operational email?",
                options: [
                    "Monthly newsletter",
                    "Product promotion",
            ...
            {
                q: "A marketer edits a global snippet used in 50 emails and approves the changes. What happens to the emails?",
                options: [
                    "Nothing happens",
            ...
            {
                q: "Which elements can be A/B tested on a Marketo landing page?",
                options: [
                    "Only the headline text",
                    "The entire page against a different page version",
                    "Only images and buttons",
                    "Only the form placement"
                ],
                correct: [1],
                explanation: "Marketo landing page A/B testing compares entire page versions against each other, not individual elements. You create multiple variants of the full page and Marketo splits traffic between them. To test specific elements like headlines or buttons, you would need to create separate page versions with those changes. The test tracks which full page version converts better based on form submissions or other success metrics."
            },
            {
                q: "A marketer edits a global form used in 10 landing pages and adds a new required field. What is the impact?",
                options: [
            ...
            {
                q: "What does it mean when an email has the 'Operational' setting enabled?",
                options: [
            ...
            {
                q: "A sales team wants to be automatically copied on emails sent to their leads. How can you configure the CC field to do this dynamically?",
                options: [
                    "Enter each sales rep's email manually",
                    "Use a token like {{lead.Lead Owner Email Address}}",
                    "CC fields don't support dynamic values",
                    "Create a separate email for each sales rep"
                ],
                correct: [1],
                explanation: "The CC field supports tokens, so you can dynamically CC the lead owner using {{lead.Lead Owner Email Address}}. This automatically copies the right sales rep without manual configuration for each email."
            },
            {
            ...
            {
                q: "A person is in the AMER segment, but an email shows them the Default segment content instead. What is the most likely cause?",
                options: [
