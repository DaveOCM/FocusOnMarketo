const questions = [
            ...
            {
                q: "Period Costs should include which of the following?",
                options: [
            ...
            },
            {
                ...
                correct: [1],
                explanation: "'Exhausted' is the official status in Marketo when a person has received every piece of content available in their current stream. They will remain exhausted until you either add new content to the stream or transition them to a different stream."
            },
            {
            ...
            {
                q: "In an Email Program A/B test, what are valid winner criteria?",
                options: [
                    "Open Rate",
                    "Total Sent",
                    "Click Rate",
            ...
            {
                q: "Period costs are entered at which level?",
                options: [
                    "Campaign level",
                    "Program level",
                    "Channel level",
